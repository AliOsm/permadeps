...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'good_job', '~> 4.1', '>= 4.1.1'
  ...
  spec.add_dependency 'bullet', '~> 7.2'
  ...
  spec.add_dependency 'rubocop', '~> 1.65', '>= 1.65.1'
  spec.add_dependency 'rubocop-minitest', '~> 0.35.1'
  spec.add_dependency 'rubocop-performance', '~> 1.21', '>= 1.21.1'
  spec.add_dependency 'rubocop-rails', '~> 2.25', '>= 2.25.1'
  spec.add_dependency 'rubocop-rake', '~> 0.6.0'
  spec.add_dependency 'rubocop-rspec', '~> 3.0', '>= 3.0.3'
